...
class SoftmaxCrossEntropyOHEMLoss(nn.Module):
    def __init__(self, ignore_label=-1, thresh=0.7, min_kept=256, use_weight=True, **kwargs): ### use_weight=True
        ...
        if use_weight:
            ...
            weight = torch.FloatTensor([0.8373, 1.1529, 1.1116, 0.8786, 1.0965, 1.0166, 1.0345, 1.0865])
