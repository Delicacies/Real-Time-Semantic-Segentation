...
#from model.ContextNet import ContextNet #added
from utils.loss import MixSoftmaxCrossEntropyLoss, MixSoftmaxCrossEntropyOHEMLoss
from utils.lr_scheduler import LRScheduler
from utils.metric import SegmentationMetric

from utils.summaries import TensorboardSummary   #added
from utils.metrics import Evaluator as Eval  #added
...
def parse_args():
    ...
    parser.add_argument('--base-size', type=int, default=640, #1024
                        help='base image size')
    parser.add_argument('--crop-size', type=int, default=640, #768
                        help='crop image size')
    parser.add_argument('--train-split', type=str, default='train', #trainval
    ...
    parser.add_argument('--lr', type=float, default=7*1e-3, metavar='LR',
...
class Trainer(object):
    def __init__(self, args):
        ...
        val_dataset = get_segmentation_dataset(args.dataset, split='val', mode='val', **data_kwargs) #split = val
    ...
    def train(self):
        ...
        for epoch in range(self.args.start_epoch, self.args.epochs):
            ...
            self.writer.add_scalar('val/total_loss_epoch', loss.item(), epoch)  #added
...
def save_checkpoint(model, args, is_best=False):
    ...
    if is_best:
        ...
        shutil.copyfile(save_path, best_filename) #changed
